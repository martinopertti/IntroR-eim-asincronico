...
## 4. Usa summary() para obtener un resumen de las variables
...
## 13. Crea una nueva variable "gdp_log"con el logaritmo del PBI bruto y grafica
# un histograma de la nueva variable
